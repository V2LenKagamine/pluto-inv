...
-- OPTIMIZED: Return the table directly instead of table.Copy for read-only access
-- If callers need a copy, they should copy it themselves
function vFireGetBurningEntities()
	return burningEntities
end
